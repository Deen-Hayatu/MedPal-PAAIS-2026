...
4. **Reasoning.** The LLM receives the de-identified note and the retrieved guideline text and returns structured output: differentials with confidence, treatment lines with STG references, investigations, patient education.
